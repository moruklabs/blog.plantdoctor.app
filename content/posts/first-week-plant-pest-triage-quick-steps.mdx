...
[^1]: Colorado State University Extension. (2024). [Managing Houseplant Pests](https://extension.colostate.edu/resource/managing-houseplant-pests/). CSU Extension Resources.

[^2]: Cornell Cooperative Extension. (2024). [Houseplant Pest Management](https://rocklandcce.org/resources/houseplant-pest-management). Cornell IPM Program.

[^3]: University of Alaska Fairbanks Extension. (2024). [Houseplant Pests and Control](https://www.uaf.edu/ces/publications/database/insects-pests/houseplant-pests.php). Cooperative Extension Service.

[^4]: University of Maryland Extension. (2024). [Phytotoxicity: Chemical Damage to Garden Plants](https://extension.umd.edu/resource/phytotoxicity-chemical-damage-garden-plants/). UMD Extension.
